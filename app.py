...
- 柔軟性: 提供された『解答例』はあくまで参考である。これと構成や着眼点が異なっていても、問題の要求を満たし、かつ教科書データを踏まえた妥当な記述であれば満点を与えよ。『解答例』に含まれる要素が記述されていない場合でも、別の適切な要素で代替されており、回答として成立していれば減点するな。
...
- 柔軟性: 『解答例』は参考である。これと異なっていても、教科書データを踏まえた妥当な記述であれば満点を与えよ。『解答例』の要素が不足していても、回答として成立していれば減点するな。
