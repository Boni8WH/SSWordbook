...
class Article(BaseModel):
    title: str = Field(description="ニュースのタイトル（独自の解釈を入れず、配信元の表現を忠実に日本語へ翻訳してください。重要な固有名詞や数字、背景情報は省略しないでください）")
...
4. **翻訳の忠実性**: 記事のタイトルは、配信元の表現や含まれる情報を勝手に省略したり簡略化したりせず、忠実に日本語へ翻訳してください。ただし、直訳すぎて不自然な場合は、意味を変えない範囲で自然な日本語に整えてください。
